...
const CREATE_BOARD_MODAL = 'create-board-modal'

export function CreateBoardButton({ createBoard }: Props) {
  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={() => toggleModal(CREATE_BOARD_MODAL)}
      ...
      <ModalContainer className="fixed inset-0 bg-black/10 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-lg font-semibold mb-3">Uus tahvel</h2>

          <form
            action={async (formData) => {
              toggleModal(CREATE_BOARD_MODAL)
              setName('')
