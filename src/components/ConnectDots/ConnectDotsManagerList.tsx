...
export type ConnectDotsManagerPuzzle = {
...
type Props = {
  ...
  isAdmin: boolean
  puzzles: ConnectDotsManagerPuzzle[]
}

export function ConnectDotsManagerList({ deletePuzzle, isAdmin, puzzles }: Props) {
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold">Minu connect-dots puzzle&apos;id</h1>
            <p className="text-sm text-muted-foreground">
              Loo, muuda ja jaga connect-dots pilte. Muutmine on lubatud ainult parent-mode&apos;is.
            </p>
          </div>
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                          <Link className="hover:underline" href="/connect-dots">
                            Ava mäng
                          </Link>
