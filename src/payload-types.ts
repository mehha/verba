...
export interface Media {
  id: number;
  /**
   * Kasutaja, kes laadis faili üles. Omanik või admin saab faili muuta ja kustutada.
   */
...
export interface ConnectDotsPuzzle {
   ...
   */
  backgroundMusic?: (number | null) | Media;
  externalImageURL?: string | null;
  dots:
    | {
        [k: string]: unknown;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | ConnectDotsPuzzle;
      } | null)
    | ({
...
export interface Header {
  ...
  navItems?:
    | {
        /**
         * Optional override label for this item.
         */
        label?: string | null;
        link: {
          type?: ('reference' | 'custom') | null;
        ...
        children?:
          | {
              /**
               * Optional override label for this sub-item.
               */
              label?: string | null;
              link: {
                type?: ('reference' | 'custom') | null;
